...
Route::group(['prefix' => 'user/' . "hotels", 'middleware' => ['auth', 'verified']], function () {
...
Route::post("hotels" . '/checkAvailability', 'HotelController@checkAvailability')->name('hotel.checkAvailability');
