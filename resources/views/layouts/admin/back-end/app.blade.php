...
<body class="footer-offset">
    <!-- Builder -->
    @include('layouts.admin.back-end.partials._front-settings')
    <!-- End Builder -->
    ...
    <div class="row">
        <div class="col-12 position-fixed z-9999 mt-10rem">
            <div id="loading" class="d--none">
                <center>
                    <img width="200" src="{{ asset('storage/app/company') }}/"
    ...
    @include('layouts.admin.back-end.partials._header')
    @include('layouts.admin.back-end.partials._side-bar')
    ...
    <main id="content" role="main" class="main pointer-event">
        ...
        <!-- Footer -->
        @include('layouts.admin.back-end.partials._footer')
        <!-- End Footer -->

        @include('layouts.admin.back-end.partials._modals')
    ...
    <script>
        function call_demo() {
            toastr.info('{{ trans('keywords.Update option is disabled for demo') }}!', {
                CloseButton: true,
                ProgressBar: true
            });
        }
