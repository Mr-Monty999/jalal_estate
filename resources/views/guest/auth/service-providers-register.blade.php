...
@section('content')
    ...
    <div class="bg-light site-section bg-white" id="company-register">
        <div class="container">
            <h1 class="text-center">{{ trans('keywords.Create Service Provider Account') }}</h1>
            <br><br>
            <form method="POST" action="{{ route('guest.service-providers.register') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
