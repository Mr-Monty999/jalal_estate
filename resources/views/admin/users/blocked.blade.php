                        ...
                        <table style="text-align: {{ app()->getLocale() === 'ar' ? 'right' : 'left' }};"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th class="text-center">{{ trans('keywords.block reason') }}</th>
                                    <th class="text-center">{{ trans('keywords.block period') }}</th>
                                    <th class="text-center">{{ trans('keywords.block expired at') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            @php
                                                $latestBlock = $user
                                                    ...
                                                    ->first();
                                            @endphp
                                            <td>{{ $latestBlock->reason }}</td>
                                            <td>{{ $latestBlock->period }}&ThinSpace;{{ trans('keywords.' . $latestBlock->period_type) }}
                                            </td>
                                            <td>{{ $latestBlock->expired_at }}</td>
                                          ...
                                          src="{{ asset('storage/app/user') }}/{{ $user['icon'] }}">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-10">
                                                    ...
                                                    <a class="btn btn-outline-danger action btn-sm unblock-user"
                                                        title="{{ trans('user.unblock') }}" id="{{ $user->id }}">
                                                        {{ trans('user.unblock') }}
                                                    </a>
