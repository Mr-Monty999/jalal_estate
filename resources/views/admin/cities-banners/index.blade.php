      ...
      @section('title', trans('keywords.cities banners list'))
                      ...
                      <div class="card">
                              ...
                              <div class="row align-items-center">
                                  <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                                      <h5 class="text-capitalize d-flex gap-1">
                                          {{ trans('keywords.cities banners list') }}
                                          <span
                                              class="badge badge-soft-dark radius-50 fz-12">{{ $citiesBanners->total() }}</span>
                                      </h5>
                                  </div>
                          ...
                          <div class="table-responsive">
                              <table style="text-align: {{ app()->getLocale() === 'ar' ? 'right' : 'left' }};"
                                  ...
                                  <tbody>
                                      @foreach ($citiesBanners as $key => $cityBanner)
                                          <tr>
                                              <td>{{ $cityBanner->id }}</td>
                                              {{-- <td class="text-center">
                                            <img class="rounded" width="64"
                                                onerror="this.src='{{ asset('assets/front-end/img/image-place-holder.png') }}'"
                                                src="{{ asset('storage/app/ad') }}/{{ $cityBanner['icon'] }}">
                                        </td> --}}
                                              <td class="text-center">
                                                  <img class="rounded" width="64"
                                                      onerror="this.src='{{ asset('assets/front-end/img/image-place-holder.png') }}'"
                                              ...
                                              <td>{{ $cityBanner->description }}</td>

                                              <td>
                                                  <div class="d-flex justify-content-center gap-10">
                                                      <a class="btn btn-outline-info btn-sm square-btn"
                                                          title="{{ trans('keywords.Edit') }}"
                                                          href="{{ route('admin.cities-banners.edit', [$cityBanner->id]) }}">
                                                          <i class="tio-edit"></i>
                                                      </a>
              ...
              $(document).on('click', '.delete', function() {
                  ...
                  Swal.fire({
                      ...
                      if (result.value) {
                          ...
                          $.ajax({
                              url: "{{ route('admin.cities-banners.destroy', '') }}/" + id,
                              method: 'delete',
                              data: {
                                  id: id,
                                  //'_method': "delete"
