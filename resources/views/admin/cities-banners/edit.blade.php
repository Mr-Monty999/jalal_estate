...
@section('title', trans('keywords.edit city banner'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-10">
                ...
                {{ trans('keywords.edit city banner') }}
            </h2>
        </div>
        <!-- End Page Title -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body" style="text-align: {{ app()->getLocale() === 'ar' ? 'right' : 'left' }};">
                        <form action="{{ route('admin.cities-banners.update', 1) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 form-group">
                                    ...
                                    <input value="{{ $cityBanner->description }}" type="text" name="description"
                                ...
                                <div class="col-12 form-group">
                                    ...
                                    @foreach ($cities as $index => $city)
                                        <label for="city{{ $index }}" class="title-color">
                                            {{ $city->name }}</label>
                                        <input @checked($bannerCities && in_array($city->id, $bannerCities)) id="city{{ $index }}"
