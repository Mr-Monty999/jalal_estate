...
@section('title', trans('keywords.edit land type'))
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body" style="text-align: {{ app()->getLocale() === 'ar' ? 'right' : 'left' }};">
                        <form action="{{ route('admin.land-types.update', $landType->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $landType->name }}" type="text" name="name"
