...
@section('title', trans('keywords.Edit Neighbourhood'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-10">
                ...
                {{ trans('keywords.Edit Neighbourhood') }}
            </h2>
        </div>
        <!-- End Page Title -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body" style="text-align: {{ app()->getLocale() === 'ar' ? 'right' : 'left' }};">
                        <form action="{{ route('admin.neighbourhoods.update', $neighbourhood->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $neighbourhood->name }}" type="text" name="name"
                                        ...
                                        <select class="form-control" name="city_id" id="city_id" required>
                                            @foreach ($cities as $city)
                                                <option value="{{ $city->id }}"
                                                    @if ($neighbourhood->city && $neighbourhood->city->id == $city->id) selected @endif>
                                                    {{ $city->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('city_id')
