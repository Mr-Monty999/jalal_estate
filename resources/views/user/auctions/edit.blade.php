...
@section('content')
    <br><br><br><br><br><br>
    <div class="container">
        <form method="POST" action="{{ route('user.auctions.update', $auction->id) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="row">
                ...
                <div class="form-group col-12 col-md-6">
                    ...
                    <input name="name" value="{{ $auction->name }}" type="text" class="form-control" id="name">
                    @error('name')
                ...
                <div class="form-group col-12 col-md-6">
                    <label for="price">{{ trans('keywords.lowest bid amount') }}<span class="text-danger"
                            style="font-weight: bold">*</span></label>
                    <input name="price" value="{{ $auction->price }}" type="number" class="form-control" id="price">
                    @error('price')
                        <div style="border-radius: 30px" class="alert alert-danger text-center mt-1">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group col-12 col-md-6">
                    <label for="instrument_number">{{ trans('keywords.Instrument Number') }}<span class="text-danger"
                            style="font-weight: bold">*</span></label>
                    <input name="instrument_number" value="{{ $auction->instrument_number }}" type="number"
                ...
                <div class="form-group col-12 col-md-6">
                    ...
                    <select required name="city_id" class="form-control city_id" id="city_id">
                        ...
                        @foreach ($cities as $city)
                            <option @if ($auction->city_id == $city->id) selected @endif value="{{ $city->id }}">
                                {{ $city->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-12 col-md-6">
                    ...
                    <select required name="neighbourhood_id" class="form-control neighbourhood_id" id="neighbourhood_id">
                        @foreach ($auction->city->neighbourhoods as $neighbourhood)
                            <option @if ($neighbourhood->id == $auction->neighbourhood_id) selected @endif value="{{ $neighbourhood->id }}">
                                {{ $neighbourhood->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-12 col-md-6">
                    <label for="street">{{ trans('keywords.street') }}<span class="text-danger"
                            style="font-weight: bold">*</span></label>
                    <input name="street" value="{{ $auction->street }}" type="text" class="form-control"
                        id="street">
                    @error('street')
                        <div style="border-radius: 30px" class="alert alert-danger text-center mt-1">
                            {{ $message }}
                ...
                <div class="form-group col-12 col-md-6">
                    <label for="space">{{ trans('keywords.Space') }}<span class="text-danger"
                            style="font-weight: bold">*</span></label>
                    <input name="space" value="{{ $auction->space }}" type="number" class="form-control" id="space">
                    @error('space')
                        <div style="border-radius: 30px" class="alert alert-danger text-center mt-1">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group col-12 col-md-6">
                    <label for="north_border">{{ trans('keywords.north') }}<span class="text-danger"
                            style="font-weight: bold">*</span></label>
                    <input name="north_border" value="{{ $auction->north_border }}" type="text" class="form-control"
                        id="north_border">
                    @error('north_border')
                        <div style="border-radius: 30px" class="alert alert-danger text-center mt-1">
                            {{ $message }}
                ...
                <div class="form-group col-12 col-md-6">
                    <label for="south_border">{{ trans('keywords.south') }}<span class="text-danger"
                            style="font-weight: bold">*</span></label>
                    <input name="south_border" value="{{ $auction->south_border }}" type="text" class="form-control"
                        id="south_border">
                    @error('south_border')
                        <div style="border-radius: 30px" class="alert alert-danger text-center mt-1">
                            {{ $message }}
                ...
                <div class="form-group col-12 col-md-6">
                    <label for="east_border">{{ trans('keywords.east') }}<span class="text-danger"
                            style="font-weight: bold">*</span></label>
                    <input name="east_border" value="{{ $auction->east_border }}" type="text" class="form-control"
                        id="east_border">
                    @error('east_border')
                        <div style="border-radius: 30px" class="alert alert-danger text-center mt-1">
                            {{ $message }}
                ...
                <div class="form-group col-12 col-md-6">
                    <label for="west_border">{{ trans('keywords.west') }}<span class="text-danger"
                            style="font-weight: bold">*</span></label>
                    <input name="west_border" value="{{ $auction->west_border }}" type="text" class="form-control"
                        id="west_border">
                    @error('west_border')
                        <div style="border-radius: 30px" class="alert alert-danger text-center mt-1">
                            {{ $message }}
                ...
                <div class="form-group col-12 col-md-6">
                    ...
                    <select name="estate_classification_id" class="form-control" id="estate_classification_id">
                        @foreach ($estateClassifications as $estateClassification)
                            <option @if ($auction->estate_classification_id == $estateClassification->id) selected @endif
                ...
                <div class="form-group col-12 col-md-6">
                    ...
                    <select name="land_type_id" id="land_type_id" class="form-control">
                        ...
                        @foreach ($landTypes as $landType)
                            <option @selected($auction->land_type_id == $landType->id) value="{{ $landType->id }}">
                                {{ $landType->name }}
                            </option>
                        @endforeach
                ...
                <div class="form-group col-12 col-md-6">
                    ...
                    <textarea rows="5" name="features" class="form-control" id="features">{!! $auction->features !!}</textarea>
                    @error('features')
                        <div style="border-radius: 30px" class="alert alert-danger text-center mt-1">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group col-12 col-md-6">
                    ...
                    <textarea rows="5" name="description" class="form-control" id="description">{!! $auction->description !!}</textarea>
                    @error('description')
                        <div style="border-radius: 30px" class="alert alert-danger text-center mt-1">
                            {{ $message }}
                        </div>
